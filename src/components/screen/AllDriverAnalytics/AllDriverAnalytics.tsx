...
import {useGetAllDriverAnalytics} from "@/hooks/drivers/drivers";
import {useParams, useRouter} from "next/navigation";
import {formatPrice} from "@/utils/formateData";
import Image from "next/image";
import {IData} from "@/components/screen/DriverAnalytics/DriverAnalytics";
...
const AllDriverAnalytics = () => {
    ...
    // @ts-ignore
    const {error, data, isFetching} = useGetAllDriverAnalytics( dateFrom, dateTo, enabled);
    ...
    return (
        <div className="mt-5 shadow-md container mx-auto p-4 text-center relative">
            ...
            <h2 className="text-2xl font-bold mb-4">Аналитика по всем водителям</h2>
            <form onSubmit={ handleSubmit(onSubmit) } className="mb-4">
                ...
                <div className="ml-2 flex items-center mb-2 justify-center">
...
export default AllDriverAnalytics;